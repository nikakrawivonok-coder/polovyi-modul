# DATA_SCHEMA.md — Польовий Модуль V19.17.8
...
```js
BUILD_VERSION = "V19.17.8"
BUILD_NUMBER = "19625"
BUILD_NAME = "Unified Combat Summary Text"
```
...
## V19.17.8 — Unified combat summary text

- `setCombatBrief(...)` формує єдиний читабельний короткий підсумок для атак гравців по ворогах і ворогів по гравцях.
- Додані параметри для відображення ефективного Захисту цілі, причин модифікації Захисту, пояснення точності, набоїв і розкриття стрільця.
- `lastBriefPublic` лишається без точних HP ворогів; `lastBriefGm` зберігає точні HP для Майстра.
