...
Додано Пульт Майстра зверху у вкладці Майстра:
- сцена, активний гравець, активна ціль, видимі вороги, остання дія;
- швидкі кнопки: ускладнення, атмосфера, зачіпка, небезпека, лут, паніка ворога, фланг, тиха сцена;
- швидкий запис у журнал для всіх або тільки Майстру.

Мета:
- зробити модуль практичнішим помічником Майстра під час живої D&D-сесії;
- менше скролу;
- швидше додавати події та атмосферу.
